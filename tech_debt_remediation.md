...
### 2026-05-01 06:43 IST - CODE-001 Route-Level Auth Resolver Coverage

- Action: Added unit coverage for the real `/api/auth/resolve-crm-user` route without changing runtime auth behavior.
- Reason: The legacy helper should not be removed until the actual Admin SDK route has equivalent tests for the sensitive login branches.
- Evidence collected:
  - Runtime login already calls `/api/auth/resolve-crm-user` from `lib/context/AuthContext.tsx`.
  - The new route-level test imports `POST` from `app/api/auth/resolve-crm-user/route.ts` and mocks only Firebase Admin SDK plus rate limiting.
  - The test covers no token, invalid token, existing active user, inactive user, root-superadmin self-heal, pending-user migration, legacy mixed-case pending doc lookup, first-user bootstrap, no-profile denial, and missing-email denial.
- Files changed:
  - `CRM/elite-build-dashboard/tests/unit/resolveCrmUserRoute.test.ts`
  - `tech_debt_remediation.md`
- Runtime impact:
  - None. Test coverage and documentation only.
- Validation:
  - `npx vitest run --config vitest.config.ts tests/unit/resolveCrmUserRoute.test.ts` passed: 1 file, 10 tests.
  - `git diff --check -- CRM/elite-build-dashboard/tests/unit/resolveCrmUserRoute.test.ts tech_debt_remediation.md` passed.
  - `npx tsc --noEmit` passed.
  - `npm run test` passed: 26 unit test files, 463 tests.
  - `npm run lint` passed with the existing 43 warnings and 0 errors.
  - `npm run test:rules` passed: 10 rules test files, 340 tests.
  - `npm run test:smoke` passed locally: 2 Chromium smoke tests.
- Commit:
  - `45ea8a0 test: cover auth resolver route`
- Push:
  - Pushed to `origin/codex/ui-modernization-20260424`.
- Dev deploy:
  - `npm run deploy:dev:dry-run` passed.
  - `npm run deploy:dev` passed.
  - Cloud Run revision `elite-build-crm-dev-00039-wuf` was promoted to 100% traffic.
  - Service URL: `https://elite-build-crm-dev-zrpcw3j22q-el.a.run.app`.
- Live smoke:
  - `PLAYWRIGHT_BASE_URL=https://elite-build-crm-dev-zrpcw3j22q-el.a.run.app npm run test:smoke` passed: 2 Chromium smoke tests.
...
- Validation:
  ...
  - `npm run test:smoke` passed locally: 2 Chromium smoke tests.
- Commit:
  - `bbf9ca0 chore: remove theme effect state warning`.
- Push:
  - Pushed to `origin/codex/ui-modernization-20260424`.
- Dev deploy:
  - `npm run deploy:dev:dry-run` passed before deploy.
  - `npm run deploy:dev` passed.
  - Cloud Run revision `elite-build-crm-dev-00043-leb` promoted to 100% traffic.
  - Service URL: `https://elite-build-crm-dev-zrpcw3j22q-el.a.run.app`.
- Live smoke:
...
- Validation:
  ...
  - `npm run test:smoke` passed locally: 2 Chromium smoke tests.
- Commit:
  - `9e687c9 chore: tighten upload catch typing`.
- Push:
  - Pushed to `origin/codex/ui-modernization-20260424`.
- Dev deploy:
  - `npm run deploy:dev:dry-run` passed before deploy.
  - `npm run deploy:dev` passed.
  - Cloud Run revision `elite-build-crm-dev-00045-doq` promoted to 100% traffic.
  - Service URL: `https://elite-build-crm-dev-zrpcw3j22q-el.a.run.app`.
- Live smoke:
  - `PLAYWRIGHT_BASE_URL=https://elite-build-crm-dev-zrpcw3j22q-el.a.run.app npm run test:smoke` passed: 2 Chromium tests.
...
- Validation:
  ...
  - `npm run test:smoke` passed locally: 2 Chromium smoke tests.
- Commit:
  - `003b787 chore: type dashboard user identifiers`.
- Push:
  - Pushed to `origin/codex/ui-modernization-20260424`.
- Dev deploy:
  - `npm run deploy:dev:dry-run` passed before deploy.
  - `npm run deploy:dev` passed.
  - Cloud Run revision `elite-build-crm-dev-00047-tef` promoted to 100% traffic.
  - Service URL: `https://elite-build-crm-dev-zrpcw3j22q-el.a.run.app`.
- Live smoke:
  - `PLAYWRIGHT_BASE_URL=https://elite-build-crm-dev-zrpcw3j22q-el.a.run.app npm run test:smoke` passed: 2 Chromium tests.
...
- Validation:
  ...
  - `npm run test:smoke` passed locally: 2 Chromium smoke tests.
- Commit:
  - `a510694 chore: type property match updates`.
- Push:
  - Pushed to `origin/codex/ui-modernization-20260424`.
- Dev deploy:
  - `npm run deploy:dev:dry-run` passed before deploy.
  - `npm run deploy:dev` passed.
  - Cloud Run revision `elite-build-crm-dev-00049-vad` promoted to 100% traffic.
  - Service URL: `https://elite-build-crm-dev-zrpcw3j22q-el.a.run.app`.
- Live smoke:
  - `PLAYWRIGHT_BASE_URL=https://elite-build-crm-dev-zrpcw3j22q-el.a.run.app npm run test:smoke` passed: 2 Chromium tests.
...
- Validation:
  ...
  - `npm run test:smoke` passed locally: 2 Chromium smoke tests.
- Commit:
  - `5a82cdf chore: type lead page update payloads`.
- Push:
  - Pushed to `origin/codex/ui-modernization-20260424`.
- Dev deploy:
  - `npm run deploy:dev:dry-run` passed before deploy.
  - `npm run deploy:dev` passed.
  - Cloud Run revision `elite-build-crm-dev-00051-yar` promoted to 100% traffic.
  - Service URL: `https://elite-build-crm-dev-zrpcw3j22q-el.a.run.app`.
- Live smoke:
  - `PLAYWRIGHT_BASE_URL=https://elite-build-crm-dev-zrpcw3j22q-el.a.run.app npm run test:smoke` passed: 2 Chromium tests.
...
- Validation:
  ...
  - `npm run test:smoke` passed locally: 2 Chromium smoke tests.
- Commit:
  - `66b351e chore: type location autocomplete globals`.
- Push:
  - Pushed to `origin/codex/ui-modernization-20260424`.
- Dev deploy:
  - `npm run deploy:dev:dry-run` passed before deploy.
  - `npm run deploy:dev` passed.
  - Cloud Run revision `elite-build-crm-dev-00053-taf` promoted to 100% traffic.
  - Service URL: `https://elite-build-crm-dev-zrpcw3j22q-el.a.run.app`.
- Live smoke:
  - `PLAYWRIGHT_BASE_URL=https://elite-build-crm-dev-zrpcw3j22q-el.a.run.app npm run test:smoke` passed: 2 Chromium tests.
